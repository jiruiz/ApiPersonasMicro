<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="EditEmployee.aspx.cs" Inherits="ManageBusinessFront.Employees.EditEmployee"
    MasterPageFile="~/Site1.Master" %>


<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <h2>Editar al empleado: </h2>
      <div class="mb-2">
      <div class="mb-2">
      ...
      <div>
          <asp:Label runat="server" AssociatedControlID="txtState" Text="Departamento laboral"></asp:Label><br />
