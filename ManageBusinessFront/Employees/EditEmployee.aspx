<%@ Page Async="true" Language="C#" AutoEventWireup="true" 
    ...
    Inherits="ManageBusinessFront.Employees.EditEmployee"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="max-w-lg mx-auto mt-10 bg-white shadow-lg rounded-2xl p-8">
        ...
        <!-- Nombre -->
        <div class="mb-4">
            <asp:Label runat="server" AssociatedControlID="txtFirst" Text="Nombre:" 
            ...
            <asp:RequiredFieldValidator ID="reqFirst" runat="server"
                ControlToValidate="txtFirst" ErrorMessage="El nombre es obligatorio."
        ...
        <!-- Apellido -->
        <div class="mb-4">
            <asp:Label runat="server" AssociatedControlID="txtLast" Text="Apellido:" 
                CssClass="block font-medium text-gray-700 mb-1" />
        ...
        <div class="mb-4">
            ...
            <asp:TextBox ID="txtDocument" runat="server"
                MaxLength="8"
                CssClass="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <asp:RequiredFieldValidator ID="reqDocument" runat="server"
                ControlToValidate="txtDocument"
                ErrorMessage="El documento es obligatorio."
                CssClass="text-red-600 text-sm" Display="Dynamic" />
            <asp:RegularExpressionValidator ID="valDocument" runat="server"
                ControlToValidate="txtDocument"
                ValidationExpression="^\d{1,8}$"
                ErrorMessage="Solo números, máximo 8 dígitos."
                CssClass="text-red-600 text-sm" Display="Dynamic" />
        </div>
        ...
        <!-- Teléfono -->
        <div class="mb-4">
            <asp:Label runat="server" AssociatedControlID="txtPhone" Text="Teléfono:" 
                CssClass="block font-medium text-gray-700 mb-1" />
            <asp:TextBox ID="txtPhone" runat="server"
                CssClass="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <asp:RegularExpressionValidator ID="valPhone" runat="server"
                ControlToValidate="txtPhone" ValidationExpression="^\d{7,15}$"
                ErrorMessage="Ingrese solo números (7 a 15 dígitos maximo)."
                CssClass="text-red-600 text-sm" Display="Dynamic" />
        </div>
        ...
        <!-- Departamento -->
        <div class="mb-4">
            <asp:Label runat="server" AssociatedControlID="txtDept" Text="Departamento laboral:" 
                CssClass="block font-medium text-gray-700 mb-1" />
        ...
        <!-- Rango -->
        <div class="mb-6">
            <asp:Label runat="server" AssociatedControlID="txtRange" Text="Rango laboral:" 
                CssClass="block font-medium text-gray-700 mb-1" />
        ...
        <div class="flex justify-center gap-4">
            <asp:Button ID="btnSave" runat="server" Text="💾 Guardar cambios"
                CssClass="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition-transform transform hover:scale-105"
